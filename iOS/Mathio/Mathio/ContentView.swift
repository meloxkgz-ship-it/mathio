    ...
    static let defaultPaths: [LearningPath] = [
        LearningPath(
            ...
            lessons: [Curriculum.preAlgFractions, Curriculum.preAlgDecimals, Curriculum.preAlgPercents,
                      Curriculum.percentChange, Curriculum.preAlgRatios, Curriculum.unitConversions, Curriculum.preAlgRoots,
        ...
        LearningPath(
            ...
            lessons: [Curriculum.preAlgFractions, Curriculum.linearEquations, Curriculum.pythagoras,
                      ...
                      Curriculum.examTimedTriageSprint, Curriculum.examFormulaRecallSprint,
        ...
        LearningPath(
            ...
            lessons: [Curriculum.descriptiveStats, Curriculum.probabilityBasics, Curriculum.expectedValue,
                      Curriculum.conditionalProbability, Curriculum.bayesTheorem, Curriculum.dataDisplays,
...
struct PaywallView: View {
    ...
    private var bullets: some View {
        VStack(alignment: .leading, spacing: 12) {
            row("books.vertical.fill", "100 lessons across algebra, calculus, geometry, statistics, finance, exam review, and more")
    ...
    private var premiumValueGrid: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 10) {
                ...
                valueProof("map.fill", "Full roadmap", "All 100 lessons and 500 guided questions")
            }
        }
    }
