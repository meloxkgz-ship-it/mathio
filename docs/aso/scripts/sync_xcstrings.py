...
PROSE: dict[str, str] = {
    ...
    "30-Day Money Confidence": "30-Tage-Finanzsicherheit",
    "48 is close to 50": "48 liegt nahe bei 50",
    "45-Day Algebra Exam Plan": "45-Tage-Algebra-Prüfungsplan",
    "50 and 500 differ by a factor of 10": "50 und 500 unterscheiden sich um den Faktor 10",
    "60-Day Data Confidence": "60-Tage-Datensicherheit",
    ...
    "A fair coin is flipped twice. P(two heads) =": "Eine faire Münze wird zweimal geworfen. P(zweimal Kopf) =",
    "A fast algebra review for equations, slopes, functions, and quadratics.":
        "Eine schnelle Algebra-Wiederholung zu Gleichungen, Steigungen, Funktionen und quadratischen Ausdrücken.",
    "A number is doubled and then increased by 7 to make 25. The number is:":
        "Eine Zahl wird verdoppelt und dann um 7 erhöht, sodass 25 entsteht. Die Zahl ist:",
    "A quiz has 20 questions. You answered 15 correctly. What percent is that?":
        "Ein Quiz hat 20 Fragen. Du hast 15 richtig beantwortet. Wie viel Prozent sind das?",
    "A rectangular prism is 3 by 4 by 5. Its volume is:":
        "Ein Quader ist 3 mal 4 mal 5 groß. Sein Volumen ist:",
    "A runner travels 18 km in 3 hours. The average speed is:":
        "Ein Läufer legt 18 km in 3 Stunden zurück. Die Durchschnittsgeschwindigkeit ist:",
    "A taxi charges $5 plus $2 per mile. What is the cost for 8 miles?":
        "Ein Taxi kostet 5 $ Grundgebühr plus 2 $ pro Meile. Was kosten 8 Meilen?",
    "A triangle has base 10 and height 6. Its area is:":
        "Ein Dreieck hat Grundseite 10 und Höhe 6. Seine Fläche ist:",
    ...
    "Aim for three short practice days before chasing longer sessions.":
        "Ziele zuerst auf drei kurze Übungstage, bevor du längere Sitzungen anstrebst.",
    "Answers": "Antworten",
    ...
    "Check 6² + 8².": "Prüfe 6² + 8².",
    "Circle circumference": "Kreisumfang",
    "Circumference is distance around the circle.": "Der Umfang ist die Strecke einmal um den Kreis.",
    "Compare everything as decimals.": "Vergleiche alles als Dezimalzahlen.",
    "Convert a ratio into a percent by multiplying by 100.": "Wandle ein Verhältnis in Prozent um, indem du mit 100 multiplizierst.",
    "Count the outcomes you want and divide by all possible outcomes.": "Zähle die gewünschten Ergebnisse und teile durch alle möglichen Ergebnisse.",
    "Data & Probability Sprint": "Daten- & Wahrscheinlichkeits-Sprint",
    "Distance divided by time.": "Strecke geteilt durch Zeit.",
    "Divide by 2 first.": "Teile zuerst durch 2.",
    "Equal quantities stay equal when both are multiplied by the same number": "Gleiche Größen bleiben gleich, wenn beide mit derselben Zahl multipliziert werden",
    "Equation balance": "Gleichungsbalance",
    ...
    "Finish this to unlock faster visible progress.": "Schließe das ab, um schneller sichtbaren Fortschritt freizuschalten.",
    "Fraction to percent": "Bruch zu Prozent",
    "Geometry Sprint": "Geometrie-Sprint",
    "If f(x) = 2x + 1, then f(4) =": "Wenn f(x) = 2x + 1, dann ist f(4) =",
    "In y = mx + b, m is the slope.": "In y = mx + b ist m die Steigung.",
    "Larger samples reduce random variation": "Größere Stichproben verringern zufällige Schwankungen",
    "Learning season": "Lernsaison",
    ...
    "Speed = 6 km/h": "Geschwindigkeit = 6 km/h",
    "Statistics, probability, inference": "Statistik, Wahrscheinlichkeit, Inferenz",
    "Substitute 4 for x.": "Setze 4 für x ein.",
    "Subtract 4, then divide by 3.": "Subtrahiere 4 und teile dann durch 3.",
    "That makes relationships easier to track": "Dadurch lassen sich Beziehungen leichter verfolgen",
    "That usually makes estimates more reliable": "Das macht Schätzungen meistens verlässlicher",
    "The coefficient of x is 4": "Der Koeffizient von x ist 4",
    "The mean balances the data around one average value.": "Der Mittelwert bündelt die Daten in einem Durchschnittswert.",
    "The mean of 6, 8, and 10 is:": "Der Mittelwert von 6, 8 und 10 ist:",
    "The mean uses every value directly.": "Der Mittelwert nutzt jeden Wert direkt.",
    "The missing angle in a triangle with angles 40° and 65° is:": "Der fehlende Winkel in einem Dreieck mit 40° und 65° ist:",
    ...
    "Total outcomes = 5": "Alle Ergebnisse = 5",
    "Translate words into math without panic: choose variables, write relationships, then solve one step at a time.":
        "Übersetze Text ohne Panik in Mathematik: Wähle Variablen, schreibe Beziehungen auf und löse Schritt für Schritt.",
    "Triangle angles add to 180°.": "Dreieckswinkel ergeben zusammen 180°.",
    ...
    "True or false: defining a variable can make a word problem easier to solve.":
        "Richtig oder falsch: Eine Variable zu definieren kann eine Textaufgabe leichter lösbar machen.",
    "True or false: multiplying both sides of an equation by 2 keeps it balanced.":
        "Richtig oder falsch: Wenn man beide Seiten einer Gleichung mit 2 multipliziert, bleibt sie ausgeglichen.",
    "True or false: y = 4x − 7 has slope 4.": "Richtig oder falsch: y = 4x − 7 hat Steigung 4.",
    ...
    "Build a 7-day streak.": "Baue eine 7-Tage-Serie auf.",
    "Build a full week of short practice sessions.": "Baue eine volle Woche kurzer Übungssessions auf.",
    "Clear every due review question.": "Erledige alle fälligen Wiederholungsfragen.",
    "Completed last session": "Letzte Session abgeschlossen",
    "Come back for three short sessions to make Mathio feel automatic.":
        "Komm für drei kurze Sessions zurück, damit Mathio automatisch dazugehört.",
    ...
    "Equations, graphs, functions, word problems": "Gleichungen, Graphen, Funktionen, Textaufgaben",
    ...
    "First 25 correct": "Die ersten 25 Richtigen",
    ...
    "Full weekly plan": "Vollständiger Wochenplan",
    ...
    "Keep stacking correct answers while the session is warm.":
        "Sammle weiter richtige Antworten, solange die Session warm ist.",
    "Keep your weekly plan open": "Halte deinen Wochenplan offen",
    ...
    "Master the first quarter of the roadmap.": "Meistere das erste Viertel des Lernplans.",
    ...
    "Memory loop": "Gedächtnis-Schleife",
    "Mixed practice across core topics": "Gemischtes Training zu Kernthemen",
    "Mixed practice when the daily goal is done": "Gemischtes Training, wenn das Tagesziel erledigt ist",
    "Money Math": "Finanzmathe",
    "Next focus": "Nächster Fokus",
    "Next correct milestone": "Nächster Richtig-Meilenstein",
    "Next goal": "Nächstes Ziel",
    "Next study targets": "Nächste Lernziele",
    "Next win": "Nächster Erfolg",
    "Not now": "Nicht jetzt",
    ...
    "Premium unlocks every planned lesson, smart reviews, and worked solutions so the next session is always ready.":
        "Premium schaltet jede geplante Lektion, smarte Wiederholungen und Lösungswege frei, damit die nächste Session immer bereit ist.",
    "Rate Mathio": "Mathio bewerten",
    "Reach 25 correct answers to prove the routine is working.":
        "Erreiche 25 richtige Antworten und zeig, dass die Routine wirkt.",
    "Reach 250 correct answers.": "Erreiche 250 richtige Antworten.",
    "Reach 500 correct answers.": "Erreiche 500 richtige Antworten.",
    "Recommended next": "Als Nächstes empfohlen",
    "Reminder time": "Erinnerungszeit",
    "Review cleaner": "Wiederholung erledigt",
    "Review forecast": "Wiederholungs-Vorschau",
    "Reviews return on the day they matter": "Wiederholungen kommen an dem Tag zurück, an dem sie zählen",
    "Roadmap master": "Lernplan gemeistert",
    "Roadmap starter": "Lernplan gestartet",
    "roadmap": "Lernplan",
