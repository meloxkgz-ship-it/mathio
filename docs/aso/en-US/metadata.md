...
```
New: Learning Health, Study Coach, exam review, and 95 lessons.
```
...
• Premium value proof: the paywall now highlights Study Coach, Learning Health, Smart Review, and the full roadmap
...
• Conditional Probability: new statistics practice for given information, overlaps, and multiplication rules
...
• Quadratic Graphs: new algebra practice for vertex form, symmetry, opening direction, and intercepts
...
• Expanded curriculum: 95 lessons and 475 guided questions across 10 study areas
